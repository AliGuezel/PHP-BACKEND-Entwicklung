...
if(isset($_POST["senden"])) {
	...
	// Aufgabe: Prüfen Sie, ob die Captcha-Eingabe korrekt ist und geben eine passende Meldung aus 
	if(strtoupper($_POST["captcha"]) == $_SESSION["captcha"]) {
		echo "Captcha-Eingabe korrekt<br>";
	} else {
		echo "Captcha-Eingabe falsch<br>";
	}
}
